...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    // raccogli interessi (checkbox multipli)
    const interessi = Array.from(form.querySelectorAll('input[name="interessi"]:checked'))
      .map(i => i.value);
    ...
    try {
      ...
      // prova a leggere JSON; se non è JSON mostra testo grezzo
      let data, raw;
      try {
